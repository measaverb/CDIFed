...
from fedml_api.standalone.domain_generalization.models import get_all_models, get_model
...
def parse_args():
    ...
    ### CDIFED RELATED START ###
    parser.add_argument(
        "--clip_backbone", type=str, default="RN50", help="Clip backbone model."
    )
    parser.add_argument(
        "--n_ctx", type=int, default=16, help="Number of context tokens."
    )
    parser.add_argument(
        "--ctx_init", type=str, default="a_photo_of_a", help="Context initialization."
    )
    parser.add_argument(
        "--precision", type=str, default="fp32", help="Precision for training."
    )
    parser.add_argument(
        "--lr_clip", type=float, default=0.002, help="Learning rate for clipping."
    )
    parser.add_argument(
        "--epochs_clip", type=int, default=10, help="Number of epochs for clipping."
    )
    ### CDIFED RELATED END ###
    parser.add_argument(
