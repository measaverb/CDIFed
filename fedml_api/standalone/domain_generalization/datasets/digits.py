...
from torchvision.datasets import MNIST, SVHN, USPS, DatasetFolder, ImageFolder
...
from fedml_api.standalone.domain_generalization.datasets.utils.federated_dataset import (
    FederatedDataset,
    partition_digits_domain_skew_loaders,
)
...
class FedLeaDigits(FederatedDataset):
    ...
    def get_data_loaders(self, selected_domain_list=[]):
        ...
        traindls, testdls = partition_digits_domain_skew_loaders(
